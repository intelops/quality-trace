# Running Qualitytrace with AWS X-Ray (AWS Distro for OpenTelemetry & Pokeshop API)

<!--:::note
[Check out the source code on GitHub here.](https://github.com/kubeshop/tracetest/tree/main/examples/quality-trace-amazon-x-ray-pokeshop)
:::-->
