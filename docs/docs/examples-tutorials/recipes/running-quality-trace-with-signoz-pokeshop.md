# Running Qualitytrace with SigNoz (OpenTelemetry Collector & Pokeshop API)
...
- [**Qualitytrace**]<!--(https://tracetestio/) -->- Trace-based testing that generates end-to-end tests automatically from traces.
...
First, [install the CLI]<!--(https://docs.tracetest.io/getting-started/installation#install-the-tracetestcli).-->
