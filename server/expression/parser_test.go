...
func TestStringInterpolation(t *testing.T) {
	testCases := []parserTestCase{
		...
		},
		{
			...
			Query: `attr:quality-trace.response.body = '{"userID":"${attr:myapp.myspan.user_id}"}'`,
			ExpectedOutput: expression.Statement{
				Left:       attrExpr("quality-trace.response.body"),
				Comparator: "=",
				Right: &expression.Expr{
					Left: &expression.Term{
						Str: &expression.Str{
...
func TestFilters(t *testing.T) {
	testCases := []parserTestCase{
		...
		},
		{
			...
			Query: `attr:user_id = attr:quality-trace.response.body | json_path '.id'`,
			ExpectedOutput: expression.Statement{
				Left: &expression.Expr{
					Left: &expression.Term{
				...
				Right: &expression.Expr{
					Left: &expression.Term{
						Attribute: attrp("quality-trace.response.body"),
					},
					Filters: []*expression.Filter{
						{
							Name: "json_path", Args: []*expression.Term{
		...
		},
		{
			...
			Query: `attr:message = "welcome to quality-trace, ${attr:quality-trace.response.body | json_path '.name'}"`,
			ExpectedOutput: expression.Statement{
				Left: &expression.Expr{
					Left: &expression.Term{
				...
				Right: &expression.Expr{
					Left: &expression.Term{
						Str: &expression.Str{
							Text: "welcome to quality-trace, %s",
							Args: []expression.Expr{
								{
									Left: &expression.Term{
										Attribute: attrp("quality-trace.response.body"),
