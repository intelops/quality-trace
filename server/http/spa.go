...
func SPAHandler(conf spaConfig, analyticsEnabled bool, serverID, version, env string, isQualitytraceDev bool) http.HandlerFunc {
	...
	return spaHandler(
		...
		map[string]string{
			...
			"IsQualitytraceDev":       fmt.Sprintf("%t", isQualitytraceDev),
		},
	)
}
