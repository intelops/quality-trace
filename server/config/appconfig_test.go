...
func TestFlags(t *testing.T) {
	...
	t.Run("ConfigFileOK", func(t *testing.T) {
		...
		assert.Equal(t, "/quality-trace", cfg.ServerPathPrefix())
	...
	t.Run("ConfigFileDefault", func(t *testing.T) {
		...
		t.Run("OK", func(t *testing.T) {
			...
			err := copyFile("./testdata/basic.yaml", "./quality-trace.yaml")
			defer os.Remove("./quality-trace.yaml")
		...
		t.Run("MustHaveExtension", func(t *testing.T) {
			// copy an example config file to the default location
			err := copyFile("./testdata/basic.yaml", "./quality-trace")
			defer os.Remove("./quality-trace")
