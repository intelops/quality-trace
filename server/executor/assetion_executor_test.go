	...
	cases := []struct {
	...
	}{
		{
			...
			testDef: test.Specs{
				{
					...
					Assertions: []test.Assertion{
						`attr:quality-trace.span.duration = 2000ns`,
					},
				},
			},
			trace: traces.Trace{
				RootSpan: traces.Span{
					...
					Attributes: traces.Attributes{
						...
						"quality-trace.span.duration": "2000",
					},
				},
			},
			...
			expectedResult: (maps.Ordered[test.SpanQuery, []test.AssertionResult]{}).MustAdd(`span[service.name="Pokeshop"]`, []test.AssertionResult{
				{
					Assertion: `attr:quality-trace.span.duration = 2000ns`,
		...
		},
		{
			...
			expectedResult: (maps.Ordered[test.SpanQuery, []test.AssertionResult]{}).MustAdd(`span[service.name="Pokeshop"]`, []test.AssertionResult{
				{
					Assertion: `attr:quality-trace.selected_spans.count = 1`,
					Results: []test.SpanAssertionResult{
						{
							SpanID:        &spanID,
							ObservedValue: "1",
				...
				{
					Assertion: `attr:quality-trace.selected_spans.count = 0`,
					Results: []test.SpanAssertionResult{
						{
							SpanID:        nil,
							ObservedValue: "0",
		...
		// https://github.com/kubeshop/tracetest/issues/617
		{
			...
			testDef: test.Specs{
				{
					...
					Assertions: []test.Assertion{
						...
						`attr:quality-trace.span.duration <= 21ms`,
					},
				},
			},
			trace: traces.Trace{
				RootSpan: traces.Span{
					...
					Attributes: traces.Attributes{
						...
						"quality-trace.span.duration": "21000000",
					},
				},
			},
			expectedAllPassed: true,
			expectedResult: (maps.Ordered[test.SpanQuery, []test.AssertionResult]{}).MustAdd(`span[service.name="Pokeshop"]`, []test.AssertionResult{
				...
				{
					Assertion: `attr:quality-trace.span.duration <= 21ms`,
					Results: []test.SpanAssertionResult{
						{
							SpanID:        &spanID,
							ObservedValue: "21ms",
		...
		// https://github.com/kubeshop/tracetest/issues/1203
		{
			...
			testDef: test.Specs{
				{
					Selector: test.SpanQuery(`span[service.name="Pokeshop"]`),
					Assertions: []test.Assertion{
						`attr:quality-trace.span.duration <= 25ms`,
					},
				},
			},
			trace: traces.Trace{
				RootSpan: traces.Span{
					...
					Attributes: traces.Attributes{
						"service.name":                "Pokeshop",
						"http.response.body":          `{"id":52}`,
						"quality-trace.span.duration": "25187564", // 25ms
					},
				},
			},
			expectedAllPassed: true,
			expectedResult: (maps.Ordered[test.SpanQuery, []test.AssertionResult]{}).MustAdd(`span[service.name="Pokeshop"]`, []test.AssertionResult{
				{
					Assertion: `attr:quality-trace.span.duration <= 25ms`,
					Results: []test.SpanAssertionResult{
						{
							SpanID:        &spanID,
							ObservedValue: "25ms",
			...
			trace: traces.Trace{
				RootSpan: traces.Span{
					...
					Attributes: traces.Attributes{
						"service.name":                "Pokeshop",
						"http.response.body":          `{"id":52}`,
						"quality-trace.span.duration": "35000000", // 35ms
					},
				},
			},
