...
// checks if the TestResourceList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TestResourceList{}
...
// NewTestResourceList instantiates a new TestResourceList object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTestResourceList() *TestResourceList {
	this := TestResourceList{}
	return &this
}

// NewTestResourceListWithDefaults instantiates a new TestResourceList object
...
func (v NullableTestResourceList) Get() *TestResourceList {
	return v.value
}

func (v *NullableTestResourceList) Set(val *TestResourceList) {
	v.value = val
	v.isSet = true
}
...
func NewNullableTestResourceList(val *TestResourceList) *NullableTestResourceList {
	return &NullableTestResourceList{value: val, isSet: true}
}
