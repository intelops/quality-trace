...
const (
	...
	WithoutDemoInstallationModeType InstallationModeType = "just-quality-trace"
...
func (e *InstallationModeType) Set(v string) error {
	switch v {
	case "with-demo", "just-quality-trace":
		*e = InstallationModeType(v)
		return nil
	default:
		return errors.New(`must be "with-demo" or "just-quality-trace"`)
	}
}

func (e *InstallationModeType) Type() string {
	return "(with-demo|just-quality-trace)"
}
